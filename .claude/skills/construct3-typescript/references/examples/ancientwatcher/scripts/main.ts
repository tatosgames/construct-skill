...
let playerCol: InstanceType.PlayerCollider;
let playerModel: InstanceType.PlayerModel;
let bossCol: InstanceType.BossCollider;
let bossModel: InstanceType.BossModel;
let bossFB: InstanceType.BossFloorBlast;
let uiLifeBar: InstanceType.UILifeBar;
let uiLifeBarSupport: InstanceType.UILifeBarSupport;
let uiLifeBarName: InstanceType.UILifeBarName;
let uiTutorialText: InstanceType.UITutorialText;
let uiFader: InstanceType.UIFader;
let uiDeathText: InstanceType.UIDeathText;
let uiVictoryText: InstanceType.UIVictoryText;
let uiPressEnter: InstanceType.UIPressEnter;

// Textures
let tex: {
    "pIdle": IObjectType<InstanceType.TexPlayerIdle>;
    "pWalk": IObjectType<InstanceType.TexPlayerWalk>;
    "pDashL": IObjectType<InstanceType.TexPlayerDashL>;
    "pDashR": IObjectType<InstanceType.TexPlayerDashR>;
    "pHit": IObjectType<InstanceType.TexPlayerHit>;
    "bIdle": IObjectType<InstanceType.TexBossIdle>;
    "bAttack": IObjectType<InstanceType.TexBossAttack>;
    "bFBExp": IObjectType<InstanceType.TexBossFBExp>
};
...
// Gameplay variables
let camLookX: number; // Camera look X position
let camLookY: number; // Camera look Y position
...
function restartGame(runtime: IRuntime) {
    // (Re)start the game
...
function checkBossTimer(runtime: IRuntime) {
    // Boss OnTimer events
...
function movePlayerModel(runtime: IRuntime) {
...
function playerDashState(runtime: IRuntime) {
...
function computeCollisions(runtime: IRuntime) {
...
function setCamera3D(runtime: IRuntime) {
...
function playerDeath(runtime: IRuntime) {
    // Player death
...
function stopEverything(runtime: IRuntime) {

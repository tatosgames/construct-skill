	...
	Move()
	{
		...
		if (playerInst)
		{
								 ...
								 playerInst.x, playerInst.y) < 200)
			{
				...
				this.angle = Utils.angleRotate(this.angle, angleToPlayer,
											   Utils.toRadians(1));
			}
